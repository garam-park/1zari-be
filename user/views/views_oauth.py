...
from user.schemas import KakaoLoginRequest, KakaoLoginResponse, NaverLoginRequest, NaverLoginResponse
    ...
    def get(self, request: HttpRequest, *args: Any, **kwargs: Any) -> JsonResponse:
        try:
            ...
            if not user_data:
                ...
                return JsonResponse({"message": "카카오 사용자 정보 요청 실패"}, status=400)
    ...
    def get(self, request: HttpRequest, *args: Any, **kwargs: Any) -> JsonResponse:
        try:
            ...
            if not code or not state:
                return JsonResponse({"message": "code와 state가 필요합니다."}, status=400)
            ...
            if not user_data:
                return JsonResponse({"message": "네이버 사용자 정보 요청 실패"}, status=400)
